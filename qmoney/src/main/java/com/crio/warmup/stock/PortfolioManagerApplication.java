...
public class PortfolioManagerApplication {
  ...
  public static List<String> mainReadFile(String[] args) throws IOException, URISyntaxException {
    //we call readTradesFromJson
    List<PortfolioTrade> trades= readTradesFromJson(args[0]);
    //Collect the stock symbols into a list, which we can use later
  ...
  public static List<String> debugOutputs() {
   //module 1
     ...
     String resultOfResolveFilePathArgs0 = "/home/crio-user/workspace/satishvennapu3-ME_QMONEY_V2/qmoney/bin/main/trades.json";
     String toStringOfObjectMapper = "com.fasterxml.jackson.databind.ObjectMapper@44c03695";
     String functionNameFromTestFileInStackTrace = "PortfolioManagerApplicationTest.mainReadFile()";
     String lineNumberFromTestFileInStackTrace = "23";
  ...
  public static List<String> mainReadQuotes(String[] args) throws IOException, URISyntaxException {
    ...
    for(PortfolioTrade trade : trades){
      ...
      TotalReturnsDto totalReturnsDto =new TotalReturnsDto(trade.getSymbol(), getClosingPriceOnEndDate(candleList));
      totalReturns.add(totalReturnsDto);
    }

    Collections.sort(totalReturns);
    List<String> quotes= new ArrayList<>();
    for(TotalReturnsDto dto : totalReturns){
      quotes.add(dto.getSymbol());
    }
     return quotes;
  }
  ...
  public static List<PortfolioTrade> readTradesFromJson(String filename) throws IOException, URISyntaxException {
    ...
    //Read the stocks in the portfolio using (ObjectMapper).
